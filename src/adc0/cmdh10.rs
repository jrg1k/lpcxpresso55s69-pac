#[doc = "Register `CMDH10` reader"]
pub type R = crate::R<Cmdh10Spec>;
#[doc = "Register `CMDH10` writer"]
pub type W = crate::W<Cmdh10Spec>;
...
impl W {
    #[doc = "Bit 2 - Wait for trigger assertion before execution."]
    #[inline(always)]
    pub fn wait_trig(&mut self) -> WaitTrigW<Cmdh10Spec> {
        WaitTrigW::new(self, 2)
    }
    #[doc = "Bit 7 - Loop with Increment"]
    #[inline(always)]
    pub fn lwi(&mut self) -> LwiW<Cmdh10Spec> {
        LwiW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Sample Time Select"]
    #[inline(always)]
    pub fn sts(&mut self) -> StsW<Cmdh10Spec> {
        StsW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Hardware Average Select"]
    #[inline(always)]
    pub fn avgs(&mut self) -> AvgsW<Cmdh10Spec> {
        AvgsW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Loop Count Select"]
    #[inline(always)]
    pub fn loop_(&mut self) -> LoopW<Cmdh10Spec> {
        LoopW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Next Command Select"]
    #[inline(always)]
    pub fn next(&mut self) -> NextW<Cmdh10Spec> {
        NextW::new(self, 24)
    }
}
#[doc = "ADC Command High Buffer Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmdh10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmdh10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmdh10Spec;
impl crate::RegisterSpec for Cmdh10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmdh10::R`](R) reader structure"]
impl crate::Readable for Cmdh10Spec {}
#[doc = "`write(|w| ..)` method takes [`cmdh10::W`](W) writer structure"]
impl crate::Writable for Cmdh10Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMDH10 to value 0"]
impl crate::Resettable for Cmdh10Spec {

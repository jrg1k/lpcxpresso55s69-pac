#[doc = "Register `CMDL14` reader"]
pub type R = crate::R<Cmdl14Spec>;
#[doc = "Register `CMDL14` writer"]
pub type W = crate::W<Cmdl14Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Input channel select"]
    #[inline(always)]
    pub fn adch(&mut self) -> AdchW<Cmdl14Spec> {
        AdchW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Conversion Type"]
    #[inline(always)]
    pub fn ctype(&mut self) -> CtypeW<Cmdl14Spec> {
        CtypeW::new(self, 5)
    }
    #[doc = "Bit 7 - Select resolution of conversions"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Cmdl14Spec> {
        ModeW::new(self, 7)
    }
}
#[doc = "ADC Command Low Buffer Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmdl14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmdl14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmdl14Spec;
impl crate::RegisterSpec for Cmdl14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmdl14::R`](R) reader structure"]
impl crate::Readable for Cmdl14Spec {}
#[doc = "`write(|w| ..)` method takes [`cmdl14::W`](W) writer structure"]
impl crate::Writable for Cmdl14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMDL14 to value 0"]
impl crate::Resettable for Cmdl14Spec {

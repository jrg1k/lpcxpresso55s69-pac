#[doc = "Register `CMDL6` reader"]
pub type R = crate::R<Cmdl6Spec>;
#[doc = "Register `CMDL6` writer"]
pub type W = crate::W<Cmdl6Spec>;
...
impl W {
    #[doc = "Bits 0:4 - Input channel select"]
    #[inline(always)]
    pub fn adch(&mut self) -> AdchW<Cmdl6Spec> {
        AdchW::new(self, 0)
    }
    #[doc = "Bits 5:6 - Conversion Type"]
    #[inline(always)]
    pub fn ctype(&mut self) -> CtypeW<Cmdl6Spec> {
        CtypeW::new(self, 5)
    }
    #[doc = "Bit 7 - Select resolution of conversions"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Cmdl6Spec> {
        ModeW::new(self, 7)
    }
}
#[doc = "ADC Command Low Buffer Register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmdl6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmdl6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cmdl6Spec;
impl crate::RegisterSpec for Cmdl6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cmdl6::R`](R) reader structure"]
impl crate::Readable for Cmdl6Spec {}
#[doc = "`write(|w| ..)` method takes [`cmdl6::W`](W) writer structure"]
impl crate::Writable for Cmdl6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CMDL6 to value 0"]
impl crate::Resettable for Cmdl6Spec {

...
impl From<FifoSelA> for bool {
    #[inline(always)]
    fn from(variant: FifoSelA) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FIFO_SEL_A` reader - SAR Result Destination For Channel A"]
pub type FifoSelAR = crate::BitReader<FifoSelA>;
impl FifoSelAR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FifoSelA {
        match self.bits {
            false => FifoSelA::FifoSelA0,
            true => FifoSelA::FifoSelA1,
        }
    }
    #[doc = "Result written to FIFO 0"]
    #[inline(always)]
    pub fn is_fifo_sel_a_0(&self) -> bool {
        *self == FifoSelA::FifoSelA0
    }
    #[doc = "Result written to FIFO 1"]
    #[inline(always)]
    pub fn is_fifo_sel_a_1(&self) -> bool {
        *self == FifoSelA::FifoSelA1
    }
}
#[doc = "Field `FIFO_SEL_A` writer - SAR Result Destination For Channel A"]
pub type FifoSelAW<'a, REG> = crate::BitWriter<'a, REG, FifoSelA>;
impl<'a, REG> FifoSelAW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Result written to FIFO 0"]
    #[inline(always)]
    pub fn fifo_sel_a_0(self) -> &'a mut crate::W<REG> {
        self.variant(FifoSelA::FifoSelA0)
    }
    #[doc = "Result written to FIFO 1"]
    #[inline(always)]
    pub fn fifo_sel_a_1(self) -> &'a mut crate::W<REG> {
        self.variant(FifoSelA::FifoSelA1)
    }
}
...
impl From<FifoSelB> for bool {
    #[inline(always)]
    fn from(variant: FifoSelB) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FIFO_SEL_B` reader - SAR Result Destination For Channel B"]
pub type FifoSelBR = crate::BitReader<FifoSelB>;
impl FifoSelBR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> FifoSelB {
        match self.bits {
            false => FifoSelB::FifoSelB0,
            true => FifoSelB::FifoSelB1,
        }
    }
    #[doc = "Result written to FIFO 0"]
    #[inline(always)]
    pub fn is_fifo_sel_b_0(&self) -> bool {
        *self == FifoSelB::FifoSelB0
    }
    #[doc = "Result written to FIFO 1"]
    #[inline(always)]
    pub fn is_fifo_sel_b_1(&self) -> bool {
        *self == FifoSelB::FifoSelB1
    }
}
#[doc = "Field `FIFO_SEL_B` writer - SAR Result Destination For Channel B"]
pub type FifoSelBW<'a, REG> = crate::BitWriter<'a, REG, FifoSelB>;
impl<'a, REG> FifoSelBW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Result written to FIFO 0"]
    #[inline(always)]
    pub fn fifo_sel_b_0(self) -> &'a mut crate::W<REG> {
        self.variant(FifoSelB::FifoSelB0)
    }
    #[doc = "Result written to FIFO 1"]
    #[inline(always)]
    pub fn fifo_sel_b_1(self) -> &'a mut crate::W<REG> {
        self.variant(FifoSelB::FifoSelB1)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn fifo_sel_a(&self) -> FifoSelAR {
        FifoSelAR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - SAR Result Destination For Channel B"]
    #[inline(always)]
    pub fn fifo_sel_b(&self) -> FifoSelBR {
        FifoSelBR::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - SAR Result Destination For Channel A"]
    #[inline(always)]
    pub fn fifo_sel_a(&mut self) -> FifoSelAW<TctrlSpec> {
        FifoSelAW::new(self, 1)
    }
    #[doc = "Bit 2 - SAR Result Destination For Channel B"]
    #[inline(always)]
    pub fn fifo_sel_b(&mut self) -> FifoSelBW<TctrlSpec> {
        FifoSelBW::new(self, 2)
    }
    #[doc = "Bits 8:11 - Trigger priority setting"]
    #[inline(always)]

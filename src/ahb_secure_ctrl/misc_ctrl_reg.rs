...
pub type R = crate::R<MiscCtrlRegSpec>;
...
#[doc = "secure control register\n\nYou can [`read`](crate::Reg::read) this register and get [`misc_ctrl_reg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`misc_ctrl_reg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MiscCtrlRegSpec;
impl crate::RegisterSpec for MiscCtrlRegSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`misc_ctrl_reg::R`](R) reader structure"]
impl crate::Readable for MiscCtrlRegSpec {}
#[doc = "`write(|w| ..)` method takes [`misc_ctrl_reg::W`](W) writer structure"]
impl crate::Writable for MiscCtrlRegSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MISC_CTRL_REG to value 0xaaaa"]
impl crate::Resettable for MiscCtrlRegSpec {

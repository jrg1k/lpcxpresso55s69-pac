#[doc = "Register `SEC_CTRL_RAM1_MEM_RULE0` reader"]
pub type R = crate::R<SecCtrlRam1MemRule0Spec>;
#[doc = "Register `SEC_CTRL_RAM1_MEM_RULE0` writer"]
pub type W = crate::W<SecCtrlRam1MemRule0Spec>;
...
impl W {
    #[doc = "Bits 0:1 - secure control rule0. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule0(&mut self) -> Rule0W<SecCtrlRam1MemRule0Spec> {
        Rule0W::new(self, 0)
    }
    #[doc = "Bits 4:5 - secure control rule1. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule1(&mut self) -> Rule1W<SecCtrlRam1MemRule0Spec> {
        Rule1W::new(self, 4)
    }
    #[doc = "Bits 8:9 - secure control rule2. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule2(&mut self) -> Rule2W<SecCtrlRam1MemRule0Spec> {
        Rule2W::new(self, 8)
    }
    #[doc = "Bits 12:13 - secure control rule3. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule3(&mut self) -> Rule3W<SecCtrlRam1MemRule0Spec> {
        Rule3W::new(self, 12)
    }
    #[doc = "Bits 16:17 - secure control rule4. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule4(&mut self) -> Rule4W<SecCtrlRam1MemRule0Spec> {
        Rule4W::new(self, 16)
    }
    #[doc = "Bits 20:21 - secure control rule5. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule5(&mut self) -> Rule5W<SecCtrlRam1MemRule0Spec> {
        Rule5W::new(self, 20)
    }
    #[doc = "Bits 24:25 - secure control rule6. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule6(&mut self) -> Rule6W<SecCtrlRam1MemRule0Spec> {
        Rule6W::new(self, 24)
    }
    #[doc = "Bits 28:29 - secure control rule7. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule7(&mut self) -> Rule7W<SecCtrlRam1MemRule0Spec> {
        Rule7W::new(self, 28)
    }
}
#[doc = "Security access rules for RAM1 slaves.\n\nYou can [`read`](crate::Reg::read) this register and get [`sec_ctrl_ram1_mem_rule0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sec_ctrl_ram1_mem_rule0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SecCtrlRam1MemRule0Spec;
impl crate::RegisterSpec for SecCtrlRam1MemRule0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sec_ctrl_ram1_mem_rule0::R`](R) reader structure"]
impl crate::Readable for SecCtrlRam1MemRule0Spec {}
#[doc = "`write(|w| ..)` method takes [`sec_ctrl_ram1_mem_rule0::W`](W) writer structure"]
impl crate::Writable for SecCtrlRam1MemRule0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SEC_CTRL_RAM1_MEM_RULE0 to value 0"]
impl crate::Resettable for SecCtrlRam1MemRule0Spec {

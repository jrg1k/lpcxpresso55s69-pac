...
pub type R = crate::R<Ringo2CtrlSpec>;
#[doc = "Register `RINGO2_CTRL` writer"]
pub type W = crate::W<Ringo2CtrlSpec>;
...
impl W {
    #[doc = "Bit 0 - Select short or long ringo (for all ringos types)."]
    #[inline(always)]
    pub fn s(&mut self) -> SW<Ringo2CtrlSpec> {
        SW::new(self, 0)
    }
    #[doc = "Bit 1 - Ringo frequency output divider."]
    #[inline(always)]
    pub fn fs(&mut self) -> FsW<Ringo2CtrlSpec> {
        FsW::new(self, 1)
    }
    #[doc = "Bit 2 - Ringo module Power control."]
    #[inline(always)]
    pub fn pd(&mut self) -> PdW<Ringo2CtrlSpec> {
        PdW::new(self, 2)
    }
    #[doc = "Bit 3 - ."]
    #[inline(always)]
    pub fn e_r24(&mut self) -> ER24W<Ringo2CtrlSpec> {
        ER24W::new(self, 3)
    }
    #[doc = "Bit 4 - ."]
    #[inline(always)]
    pub fn e_r35(&mut self) -> ER35W<Ringo2CtrlSpec> {
        ER35W::new(self, 4)
    }
    #[doc = "Bit 5 - Metal 2 (M2) monitor control."]
    #[inline(always)]
    pub fn e_m2(&mut self) -> EM2W<Ringo2CtrlSpec> {
        EM2W::new(self, 5)
    }
    #[doc = "Bit 6 - Metal 3 (M3) monitor control."]
    #[inline(always)]
    pub fn e_m3(&mut self) -> EM3W<Ringo2CtrlSpec> {
        EM3W::new(self, 6)
    }
    #[doc = "Bit 7 - Metal 4 (M4) monitor control."]
    #[inline(always)]
    pub fn e_m4(&mut self) -> EM4W<Ringo2CtrlSpec> {
        EM4W::new(self, 7)
    }
    #[doc = "Bit 8 - Metal 5 (M5) monitor control."]
    #[inline(always)]
    pub fn e_m5(&mut self) -> EM5W<Ringo2CtrlSpec> {
        EM5W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Ringo out Clock divider value. Frequency Output = Frequency input / (DIViSOR+1). (minimum = Frequency input / 16)"]
    #[inline(always)]
    pub fn divisor(&mut self) -> DivisorW<Ringo2CtrlSpec> {
        DivisorW::new(self, 16)
    }
}
#[doc = "Third Ring Oscillator module control register.\n\nYou can [`read`](crate::Reg::read) this register and get [`ringo2_ctrl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ringo2_ctrl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ringo2CtrlSpec;
impl crate::RegisterSpec for Ringo2CtrlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ringo2_ctrl::R`](R) reader structure"]
impl crate::Readable for Ringo2CtrlSpec {}
#[doc = "`write(|w| ..)` method takes [`ringo2_ctrl::W`](W) writer structure"]
impl crate::Writable for Ringo2CtrlSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RINGO2_CTRL to value 0x40"]
impl crate::Resettable for Ringo2CtrlSpec {

...
pub mod ctrl1;
#[doc = "LOADER (rw) register accessor: Contains an optional loader to load into CTRL0/1 in steps to perform a set of operations.\n\nYou can [`read`](crate::Reg::read) this register and get [`loader::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`loader::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@loader`]
module"]
#[doc(alias = "LOADER")]
pub type Loader = crate::Reg<loader::LoaderSpec>;

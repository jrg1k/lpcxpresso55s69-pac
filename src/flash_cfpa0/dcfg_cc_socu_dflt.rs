...
impl W {
    #[doc = "Bit 0 - Non Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub fn niden(&mut self) -> NidenW<DcfgCcSocuDfltSpec> {
        NidenW::new(self, 0)
    }
    #[doc = "Bit 1 - Non Secure debug fixed state"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<DcfgCcSocuDfltSpec> {
        DbgenW::new(self, 1)
    }
    #[doc = "Bit 2 - Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub fn spniden(&mut self) -> SpnidenW<DcfgCcSocuDfltSpec> {
        SpnidenW::new(self, 2)
    }
    #[doc = "Bit 3 - Secure invasive debug fixed state"]
    #[inline(always)]
    pub fn spiden(&mut self) -> SpidenW<DcfgCcSocuDfltSpec> {
        SpidenW::new(self, 3)
    }
    #[doc = "Bit 4 - JTAG TAP fixed state"]
    #[inline(always)]
    pub fn tapen(&mut self) -> TapenW<DcfgCcSocuDfltSpec> {
        TapenW::new(self, 4)
    }
    #[doc = "Bit 5 - CPU1 (Micro cortex M33) invasive debug fixed state"]
    #[inline(always)]
    pub fn cpu1_dbgen(&mut self) -> Cpu1DbgenW<DcfgCcSocuDfltSpec> {
        Cpu1DbgenW::new(self, 5)
    }
    #[doc = "Bit 6 - ISP Boot Command fixed state"]
    #[inline(always)]
    pub fn isp_cmd_en(&mut self) -> IspCmdEnW<DcfgCcSocuDfltSpec> {
        IspCmdEnW::new(self, 6)
    }
    #[doc = "Bit 7 - FA Command fixed state"]
    #[inline(always)]
    pub fn fa_cmd_en(&mut self) -> FaCmdEnW<DcfgCcSocuDfltSpec> {
        FaCmdEnW::new(self, 7)
    }
    #[doc = "Bit 8 - Flash Mass Erase Command fixed state"]
    #[inline(always)]
    pub fn me_cmd_en(&mut self) -> MeCmdEnW<DcfgCcSocuDfltSpec> {
        MeCmdEnW::new(self, 8)
    }
    #[doc = "Bit 9 - CPU1 (Micro cortex M33) non-invasive debug fixed state"]
    #[inline(always)]
    pub fn cpu1_niden(&mut self) -> Cpu1NidenW<DcfgCcSocuDfltSpec> {
        Cpu1NidenW::new(self, 9)
    }
    #[doc = "Bits 16:31 - inverse value of bits \\[15:0\\]"]
    #[inline(always)]
    pub fn inverse_value(&mut self) -> InverseValueW<DcfgCcSocuDfltSpec> {

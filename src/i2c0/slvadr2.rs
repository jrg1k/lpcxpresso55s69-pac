...
pub type R = crate::R<Slvadr2Spec>;
#[doc = "Register `SLVADR2` writer"]
pub type W = crate::W<Slvadr2Spec>;
...
impl W {
    #[doc = "Bit 0 - Slave Address n Disable."]
    #[inline(always)]
    pub fn sadisable(&mut self) -> SadisableW<Slvadr2Spec> {
        SadisableW::new(self, 0)
    }
    #[doc = "Bits 1:7 - Slave Address. Seven bit slave address that is compared to received addresses if enabled."]
    #[inline(always)]
    pub fn slvadr(&mut self) -> SlvadrW<Slvadr2Spec> {
        SlvadrW::new(self, 1)
    }
}
#[doc = "Slave address register.\n\nYou can [`read`](crate::Reg::read) this register and get [`slvadr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`slvadr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Slvadr2Spec;
impl crate::RegisterSpec for Slvadr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`slvadr2::R`](R) reader structure"]
impl crate::Readable for Slvadr2Spec {}
#[doc = "`write(|w| ..)` method takes [`slvadr2::W`](W) writer structure"]
impl crate::Writable for Slvadr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SLVADR2 to value 0x01"]
impl crate::Resettable for Slvadr2Spec {

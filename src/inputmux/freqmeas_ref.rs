...
pub type R = crate::R<FreqmeasRefSpec>;
#[doc = "Register `FREQMEAS_REF` writer"]
pub type W = crate::W<FreqmeasRefSpec>;
...
#[doc = "Field `CLKIN` reader - Clock source number (decimal value) for frequency measure function reference clock:"]
...
#[doc = "Field `CLKIN` writer - Clock source number (decimal value) for frequency measure function reference clock:"]
...
impl R {
    #[doc = "Bits 0:4 - Clock source number (decimal value) for frequency measure function reference clock:"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - Clock source number (decimal value) for frequency measure function reference clock:"]
    #[inline(always)]
    pub fn clkin(&mut self) -> ClkinW<FreqmeasRefSpec> {
        ClkinW::new(self, 0)
    }
}
...
pub struct FreqmeasRefSpec;
impl crate::RegisterSpec for FreqmeasRefSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`freqmeas_ref::R`](R) reader structure"]
impl crate::Readable for FreqmeasRefSpec {}
#[doc = "`write(|w| ..)` method takes [`freqmeas_ref::W`](W) writer structure"]
impl crate::Writable for FreqmeasRefSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FREQMEAS_REF to value 0x1f"]
impl crate::Resettable for FreqmeasRefSpec {

...
pub type R = crate::R<Pio0_13Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Selects pin function."]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<Pio0_13Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Pio0_13Spec> {
        ModeW::new(self, 4)
    }
    #[doc = "Bit 6 - Driver slew rate."]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<Pio0_13Spec> {
        SlewW::new(self, 6)
    }
    #[doc = "Bit 7 - Input polarity."]
    #[inline(always)]
    pub fn invert(&mut self) -> InvertW<Pio0_13Spec> {
        InvertW::new(self, 7)
    }
    #[doc = "Bit 8 - Select Digital mode."]
    #[inline(always)]
    pub fn digimode(&mut self) -> DigimodeW<Pio0_13Spec> {
        DigimodeW::new(self, 8)
    }
    #[doc = "Bit 9 - Controls open-drain mode in standard GPIO mode (EGP = 1). This bit has no effect in I2C mode (EGP=0)."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<Pio0_13Spec> {
        OdW::new(self, 9)
    }
    #[doc = "Bit 11 - Supply Selection bit."]
    #[inline(always)]
    pub fn ssel(&mut self) -> SselW<Pio0_13Spec> {
        SselW::new(self, 11)
    }
    #[doc = "Bit 12 - Controls input glitch filter."]
    #[inline(always)]
    pub fn filteroff(&mut self) -> FilteroffW<Pio0_13Spec> {
        FilteroffW::new(self, 12)
    }
    #[doc = "Bit 13 - Pull-up current source enable in I2C mode."]
    #[inline(always)]
    pub fn ecs(&mut self) -> EcsW<Pio0_13Spec> {
        EcsW::new(self, 13)
    }
    #[doc = "Bit 14 - Switch between GPIO mode and I2C mode."]
    #[inline(always)]
    pub fn egp(&mut self) -> EgpW<Pio0_13Spec> {
        EgpW::new(self, 14)
    }
    #[doc = "Bit 15 - Configures I2C features for standard mode, fast mode, and Fast Mode Plus operation and High-Speed mode operation."]
    #[inline(always)]
    pub fn i2cfilter(&mut self) -> I2cfilterW<Pio0_13Spec> {
        I2cfilterW::new(self, 15)
    }
}
#[doc = "Digital I/O control for port 0 pins PIO0_13\n\nYou can [`read`](crate::Reg::read) this register and get [`pio0_13::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio0_13::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio0_13Spec;
impl crate::RegisterSpec for Pio0_13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio0_13::R`](R) reader structure"]
impl crate::Readable for Pio0_13Spec {}
#[doc = "`write(|w| ..)` method takes [`pio0_13::W`](W) writer structure"]
impl crate::Writable for Pio0_13Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO0_13 to value 0x5000"]
impl crate::Resettable for Pio0_13Spec {

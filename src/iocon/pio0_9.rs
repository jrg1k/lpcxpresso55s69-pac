...
impl W {
    ...
    #[doc = "Bit 6 - Driver slew rate."]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<Pio0_9Spec> {
        SlewW::new(self, 6)
    }
    #[doc = "Bit 7 - Input polarity."]
    #[inline(always)]
    pub fn invert(&mut self) -> InvertW<Pio0_9Spec> {
        InvertW::new(self, 7)
    }
    #[doc = "Bit 8 - Select Digital mode."]
    #[inline(always)]
    pub fn digimode(&mut self) -> DigimodeW<Pio0_9Spec> {
    ...
    #[doc = "Bit 10 - Analog switch input control."]
    #[inline(always)]
    pub fn asw(&mut self) -> AswW<Pio0_9Spec> {
        AswW::new(self, 10)
    }
}
#[doc = "Digital I/O control for port 0 pins PIO0_9\n\nYou can [`read`](crate::Reg::read) this register and get [`pio0_9::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio0_9::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets PIO0_9 to value 0"]

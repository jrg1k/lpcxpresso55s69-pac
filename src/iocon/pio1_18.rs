#[doc = "Register `PIO1_18` reader"]
pub type R = crate::R<Pio1_18Spec>;
#[doc = "Register `PIO1_18` writer"]
pub type W = crate::W<Pio1_18Spec>;
...
impl W {
    #[doc = "Bits 0:3 - Selects pin function."]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<Pio1_18Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Pio1_18Spec> {
        ModeW::new(self, 4)
    }
    #[doc = "Bit 6 - Driver slew rate."]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<Pio1_18Spec> {
        SlewW::new(self, 6)
    }
    #[doc = "Bit 7 - Input polarity."]
    #[inline(always)]
    pub fn invert(&mut self) -> InvertW<Pio1_18Spec> {
        InvertW::new(self, 7)
    }
    #[doc = "Bit 8 - Select Digital mode."]
    #[inline(always)]
    pub fn digimode(&mut self) -> DigimodeW<Pio1_18Spec> {
        DigimodeW::new(self, 8)
    }
    #[doc = "Bit 9 - Controls open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<Pio1_18Spec> {
        OdW::new(self, 9)
    }
}
#[doc = "Digital I/O control for port 1 pins PIO1_18\n\nYou can [`read`](crate::Reg::read) this register and get [`pio1_18::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pio1_18::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pio1_18Spec;
impl crate::RegisterSpec for Pio1_18Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pio1_18::R`](R) reader structure"]
impl crate::Readable for Pio1_18Spec {}
#[doc = "`write(|w| ..)` method takes [`pio1_18::W`](W) writer structure"]
impl crate::Writable for Pio1_18Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PIO1_18 to value 0"]
impl crate::Resettable for Pio1_18Spec {

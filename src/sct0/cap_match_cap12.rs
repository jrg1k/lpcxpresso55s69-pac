#[doc = "Register `CAP12` reader"]
pub type R = crate::R<CapMatchCap12Spec>;
#[doc = "Register `CAP12` writer"]
pub type W = crate::W<CapMatchCap12Spec>;
...
impl W {
    #[doc = "Bits 0:15 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    pub fn capn_l(&mut self) -> CapnLW<CapMatchCap12Spec> {
        CapnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    pub fn capn_h(&mut self) -> CapnHW<CapMatchCap12Spec> {
        CapnHW::new(self, 16)
    }
}
#[doc = "SCT capture register of capture channel\n\nYou can [`read`](crate::Reg::read) this register and get [`cap_match_cap12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap_match_cap12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CapMatchCap12Spec;
impl crate::RegisterSpec for CapMatchCap12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cap_match_cap12::R`](R) reader structure"]
impl crate::Readable for CapMatchCap12Spec {}
#[doc = "`write(|w| ..)` method takes [`cap_match_cap12::W`](W) writer structure"]
impl crate::Writable for CapMatchCap12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAP12 to value 0"]
impl crate::Resettable for CapMatchCap12Spec {

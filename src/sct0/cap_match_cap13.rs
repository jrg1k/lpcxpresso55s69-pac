...
pub type R = crate::R<CapMatchCap13Spec>;
#[doc = "Register `CAP13` writer"]
pub type W = crate::W<CapMatchCap13Spec>;
...
impl W {
    #[doc = "Bits 0:15 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the lower 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    pub fn capn_l(&mut self) -> CapnLW<CapMatchCap13Spec> {
        CapnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read the 16-bit counter value at which this register was last captured. When UNIFY = 1, read the upper 16 bits of the 32-bit value at which this register was last captured."]
    #[inline(always)]
    pub fn capn_h(&mut self) -> CapnHW<CapMatchCap13Spec> {
        CapnHW::new(self, 16)
    }
}
...
#[doc = "`read()` method returns [`cap_match_cap13::R`](R) reader structure"]
impl crate::Readable for CapMatchCap13Spec {}
#[doc = "`write(|w| ..)` method takes [`cap_match_cap13::W`](W) writer structure"]
impl crate::Writable for CapMatchCap13Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAP13 to value 0"]
impl crate::Resettable for CapMatchCap13Spec {

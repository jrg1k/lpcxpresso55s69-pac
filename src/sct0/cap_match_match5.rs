#[doc = "Register `MATCH5` reader"]
pub type R = crate::R<CapMatchMatch5Spec>;
#[doc = "Register `MATCH5` writer"]
pub type W = crate::W<CapMatchMatch5Spec>;
...
impl W {
    #[doc = "Bits 0:15 - When UNIFY = 0, read or write the 16-bit value to be compared to the L counter. When UNIFY = 1, read or write the lower 16 bits of the 32-bit value to be compared to the unified counter."]
    #[inline(always)]
    pub fn matchn_l(&mut self) -> MatchnLW<CapMatchMatch5Spec> {
        MatchnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, read or write the 16-bit value to be compared to the H counter. When UNIFY = 1, read or write the upper 16 bits of the 32-bit value to be compared to the unified counter."]
    #[inline(always)]
    pub fn matchn_h(&mut self) -> MatchnHW<CapMatchMatch5Spec> {
        MatchnHW::new(self, 16)
    }
}
#[doc = "SCT match value register of match channels\n\nYou can [`read`](crate::Reg::read) this register and get [`cap_match_match5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cap_match_match5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CapMatchMatch5Spec;
impl crate::RegisterSpec for CapMatchMatch5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cap_match_match5::R`](R) reader structure"]
impl crate::Readable for CapMatchMatch5Spec {}
#[doc = "`write(|w| ..)` method takes [`cap_match_match5::W`](W) writer structure"]
impl crate::Writable for CapMatchMatch5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCH5 to value 0"]
impl crate::Resettable for CapMatchMatch5Spec {

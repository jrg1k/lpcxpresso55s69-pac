...
pub type R = crate::R<CapctrlMatchrelMatchrel11Spec>;
#[doc = "Register `MATCHREL11` writer"]
pub type W = crate::W<CapctrlMatchrelMatchrel11Spec>;
...
impl W {
    #[doc = "Bits 0:15 - When UNIFY = 0, specifies the 16-bit value to be loaded into the MATCHn_L register. When UNIFY = 1, specifies the lower 16 bits of the 32-bit value to be loaded into the MATCHn register."]
    #[inline(always)]
    pub fn reloadn_l(&mut self) -> ReloadnLW<CapctrlMatchrelMatchrel11Spec> {
        ReloadnLW::new(self, 0)
    }
    #[doc = "Bits 16:31 - When UNIFY = 0, specifies the 16-bit to be loaded into the MATCHn_H register. When UNIFY = 1, specifies the upper 16 bits of the 32-bit value to be loaded into the MATCHn register."]
    #[inline(always)]
    pub fn reloadn_h(&mut self) -> ReloadnHW<CapctrlMatchrelMatchrel11Spec> {
...
pub struct CapctrlMatchrelMatchrel11Spec;
impl crate::RegisterSpec for CapctrlMatchrelMatchrel11Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`capctrl_matchrel_matchrel11::R`](R) reader structure"]
impl crate::Readable for CapctrlMatchrelMatchrel11Spec {}
#[doc = "`write(|w| ..)` method takes [`capctrl_matchrel_matchrel11::W`](W) writer structure"]
impl crate::Writable for CapctrlMatchrelMatchrel11Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MATCHREL11 to value 0"]
impl crate::Resettable for CapctrlMatchrelMatchrel11Spec {

...
impl W {
    #[doc = "Bit 0 - Card detect."]
    #[inline(always)]
    pub fn cdet(&mut self) -> CdetW<MintstsSpec> {
        CdetW::new(self, 0)
    }
    #[doc = "Bit 1 - Response error."]
    #[inline(always)]
    pub fn re(&mut self) -> ReW<MintstsSpec> {
        ReW::new(self, 1)
    }
    #[doc = "Bit 2 - Command done."]
    #[inline(always)]
    pub fn cdone(&mut self) -> CdoneW<MintstsSpec> {
        CdoneW::new(self, 2)
    }
    #[doc = "Bit 3 - Data transfer over."]
    #[inline(always)]
    pub fn dto(&mut self) -> DtoW<MintstsSpec> {
        DtoW::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit FIFO data request."]
    #[inline(always)]
    pub fn txdr(&mut self) -> TxdrW<MintstsSpec> {
        TxdrW::new(self, 4)
    }
    #[doc = "Bit 5 - Receive FIFO data request."]
    #[inline(always)]
    pub fn rxdr(&mut self) -> RxdrW<MintstsSpec> {
        RxdrW::new(self, 5)
    }
    #[doc = "Bit 6 - Response CRC error."]
    #[inline(always)]
    pub fn rcrc(&mut self) -> RcrcW<MintstsSpec> {
        RcrcW::new(self, 6)
    }
    #[doc = "Bit 7 - Data CRC error."]
    #[inline(always)]
    pub fn dcrc(&mut self) -> DcrcW<MintstsSpec> {
        DcrcW::new(self, 7)
    }
    #[doc = "Bit 8 - Response time-out."]
    #[inline(always)]
    pub fn rto(&mut self) -> RtoW<MintstsSpec> {
        RtoW::new(self, 8)
    }
    #[doc = "Bit 9 - Data read time-out."]
    #[inline(always)]
    pub fn drto(&mut self) -> DrtoW<MintstsSpec> {
        DrtoW::new(self, 9)
    }
    #[doc = "Bit 10 - Data starvation-by-host time-out (HTO)."]
    #[inline(always)]
    pub fn hto(&mut self) -> HtoW<MintstsSpec> {
        HtoW::new(self, 10)
    }
    #[doc = "Bit 11 - FIFO underrun/overrun error."]
    #[inline(always)]
    pub fn frun(&mut self) -> FrunW<MintstsSpec> {
        FrunW::new(self, 11)
    }
    #[doc = "Bit 12 - Hardware locked write error."]
    #[inline(always)]
    pub fn hle(&mut self) -> HleW<MintstsSpec> {
        HleW::new(self, 12)
    }
    #[doc = "Bit 13 - Start-bit error."]
    #[inline(always)]
    pub fn sbe(&mut self) -> SbeW<MintstsSpec> {
        SbeW::new(self, 13)
    }
    #[doc = "Bit 14 - Auto command done."]
    #[inline(always)]
...
#[doc = "Masked Interrupt Status register\n\nYou can [`read`](crate::Reg::read) this register and get [`mintsts::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mintsts::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]

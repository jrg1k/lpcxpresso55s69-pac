...
pub type R = crate::R<AdcclkdivSpec>;
#[doc = "Register `ADCCLKDIV` writer"]
pub type W = crate::W<AdcclkdivSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<AdcclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<AdcclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<AdcclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "ADC clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`adcclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adcclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AdcclkdivSpec;
impl crate::RegisterSpec for AdcclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcclkdiv::R`](R) reader structure"]
impl crate::Readable for AdcclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`adcclkdiv::W`](W) writer structure"]
impl crate::Writable for AdcclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ADCCLKDIV to value 0x4000_0000"]
impl crate::Resettable for AdcclkdivSpec {

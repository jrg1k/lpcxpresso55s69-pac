...
pub type R = crate::R<CtimerclkselCtimerclksel1Spec>;
#[doc = "Register `CTIMERCLKSEL1` writer"]
pub type W = crate::W<CtimerclkselCtimerclksel1Spec>;
...
impl W {
    #[doc = "Bits 0:2 - CTimer 1 clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<CtimerclkselCtimerclksel1Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "CTimer 1 clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimerclksel_ctimerclksel1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimerclksel_ctimerclksel1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CtimerclkselCtimerclksel1Spec;
impl crate::RegisterSpec for CtimerclkselCtimerclksel1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimerclksel_ctimerclksel1::R`](R) reader structure"]
impl crate::Readable for CtimerclkselCtimerclksel1Spec {}
#[doc = "`write(|w| ..)` method takes [`ctimerclksel_ctimerclksel1::W`](W) writer structure"]
impl crate::Writable for CtimerclkselCtimerclksel1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTIMERCLKSEL1 to value 0x07"]
impl crate::Resettable for CtimerclkselCtimerclksel1Spec {

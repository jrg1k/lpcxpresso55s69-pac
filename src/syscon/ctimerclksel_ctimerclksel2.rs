...
pub type R = crate::R<CtimerclkselCtimerclksel2Spec>;
#[doc = "Register `CTIMERCLKSEL2` writer"]
pub type W = crate::W<CtimerclkselCtimerclksel2Spec>;
...
impl W {
    #[doc = "Bits 0:2 - CTimer 2 clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<CtimerclkselCtimerclksel2Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "CTimer 2 clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimerclksel_ctimerclksel2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimerclksel_ctimerclksel2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CtimerclkselCtimerclksel2Spec;
impl crate::RegisterSpec for CtimerclkselCtimerclksel2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimerclksel_ctimerclksel2::R`](R) reader structure"]
impl crate::Readable for CtimerclkselCtimerclksel2Spec {}
#[doc = "`write(|w| ..)` method takes [`ctimerclksel_ctimerclksel2::W`](W) writer structure"]
impl crate::Writable for CtimerclkselCtimerclksel2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTIMERCLKSEL2 to value 0x07"]
impl crate::Resettable for CtimerclkselCtimerclksel2Spec {

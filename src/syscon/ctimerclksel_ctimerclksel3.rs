#[doc = "Register `CTIMERCLKSEL3` reader"]
pub type R = crate::R<CtimerclkselCtimerclksel3Spec>;
#[doc = "Register `CTIMERCLKSEL3` writer"]
pub type W = crate::W<CtimerclkselCtimerclksel3Spec>;
...
#[doc = "Field `SEL` reader - CTimer 3 clock source select."]
...
#[doc = "Field `SEL` writer - CTimer 3 clock source select."]
...
impl R {
    #[doc = "Bits 0:2 - CTimer 3 clock source select."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - CTimer 3 clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<CtimerclkselCtimerclksel3Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "CTimer 3 clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`ctimerclksel_ctimerclksel3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ctimerclksel_ctimerclksel3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CtimerclkselCtimerclksel3Spec;
impl crate::RegisterSpec for CtimerclkselCtimerclksel3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimerclksel_ctimerclksel3::R`](R) reader structure"]
impl crate::Readable for CtimerclkselCtimerclksel3Spec {}
#[doc = "`write(|w| ..)` method takes [`ctimerclksel_ctimerclksel3::W`](W) writer structure"]
impl crate::Writable for CtimerclkselCtimerclksel3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTIMERCLKSEL3 to value 0x07"]
impl crate::Resettable for CtimerclkselCtimerclksel3Spec {

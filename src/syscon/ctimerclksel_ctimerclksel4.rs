#[doc = "Register `CTIMERCLKSEL4` reader"]
pub type R = crate::R<CtimerclkselCtimerclksel4Spec>;
#[doc = "Register `CTIMERCLKSEL4` writer"]
pub type W = crate::W<CtimerclkselCtimerclksel4Spec>;
...
#[doc = "Field `SEL` reader - CTimer 4 clock source select."]
...
#[doc = "Field `SEL` writer - CTimer 4 clock source select."]
...
impl R {
    #[doc = "Bits 0:2 - CTimer 4 clock source select."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - CTimer 4 clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<CtimerclkselCtimerclksel4Spec> {
        SelW::new(self, 0)
    }
}
...
pub struct CtimerclkselCtimerclksel4Spec;
impl crate::RegisterSpec for CtimerclkselCtimerclksel4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ctimerclksel_ctimerclksel4::R`](R) reader structure"]
impl crate::Readable for CtimerclkselCtimerclksel4Spec {}
#[doc = "`write(|w| ..)` method takes [`ctimerclksel_ctimerclksel4::W`](W) writer structure"]
impl crate::Writable for CtimerclkselCtimerclksel4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CTIMERCLKSEL4 to value 0x07"]
impl crate::Resettable for CtimerclkselCtimerclksel4Spec {

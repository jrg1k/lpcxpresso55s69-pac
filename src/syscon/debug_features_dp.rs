...
impl W {
    ...
    #[doc = "Bits 4:5 - CPU0 Secure Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_spiden(&mut self) -> Cpu0SpidenW<DebugFeaturesDpSpec> {
        Cpu0SpidenW::new(self, 4)
    }
    #[doc = "Bits 6:7 - CPU0 Secure Non Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_spniden(&mut self) -> Cpu0SpnidenW<DebugFeaturesDpSpec> {
        Cpu0SpnidenW::new(self, 6)
    }
    #[doc = "Bits 8:9 - CPU1 Invasive debug control:."]
    #[inline(always)]
    pub fn cpu1_dbgen(&mut self) -> Cpu1DbgenW<DebugFeaturesDpSpec> {
        Cpu1DbgenW::new(self, 8)
    }
    #[doc = "Bits 10:11 - CPU1 Non Invasive debug control:."]
    #[inline(always)]
    pub fn cpu1_niden(&mut self) -> Cpu1NidenW<DebugFeaturesDpSpec> {

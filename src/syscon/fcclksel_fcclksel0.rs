#[doc = "Register `FCCLKSEL0` reader"]
pub type R = crate::R<FcclkselFcclksel0Spec>;
#[doc = "Register `FCCLKSEL0` writer"]
pub type W = crate::W<FcclkselFcclksel0Spec>;
...
#[doc = "Field `SEL` writer - Flexcomm Interface 0 clock source select for Fractional Rate Divider."]
...
impl R {
    #[doc = "Bits 0:2 - Flexcomm Interface 0 clock source select for Fractional Rate Divider."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - Flexcomm Interface 0 clock source select for Fractional Rate Divider."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<FcclkselFcclksel0Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "Flexcomm Interface 0 clock source select for Fractional Rate Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`fcclksel_fcclksel0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcclksel_fcclksel0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FcclkselFcclksel0Spec;
impl crate::RegisterSpec for FcclkselFcclksel0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcclksel_fcclksel0::R`](R) reader structure"]
impl crate::Readable for FcclkselFcclksel0Spec {}
#[doc = "`write(|w| ..)` method takes [`fcclksel_fcclksel0::W`](W) writer structure"]
impl crate::Writable for FcclkselFcclksel0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCCLKSEL0 to value 0x07"]
impl crate::Resettable for FcclkselFcclksel0Spec {

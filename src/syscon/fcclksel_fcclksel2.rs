...
pub type R = crate::R<FcclkselFcclksel2Spec>;
#[doc = "Register `FCCLKSEL2` writer"]
pub type W = crate::W<FcclkselFcclksel2Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Flexcomm Interface 2 clock source select for Fractional Rate Divider."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<FcclkselFcclksel2Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "Flexcomm Interface 2 clock source select for Fractional Rate Divider\n\nYou can [`read`](crate::Reg::read) this register and get [`fcclksel_fcclksel2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fcclksel_fcclksel2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FcclkselFcclksel2Spec;
impl crate::RegisterSpec for FcclkselFcclksel2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fcclksel_fcclksel2::R`](R) reader structure"]
impl crate::Readable for FcclkselFcclksel2Spec {}
#[doc = "`write(|w| ..)` method takes [`fcclksel_fcclksel2::W`](W) writer structure"]
impl crate::Writable for FcclkselFcclksel2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FCCLKSEL2 to value 0x07"]
impl crate::Resettable for FcclkselFcclksel2Spec {

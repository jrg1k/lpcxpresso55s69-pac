...
pub type R = crate::R<FrohfdivSpec>;
#[doc = "Register `FROHFDIV` writer"]
pub type W = crate::W<FrohfdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<FrohfdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<FrohfdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<FrohfdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "FRO_HF (96MHz) clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`frohfdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`frohfdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FrohfdivSpec;
impl crate::RegisterSpec for FrohfdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`frohfdiv::R`](R) reader structure"]
impl crate::Readable for FrohfdivSpec {}
#[doc = "`write(|w| ..)` method takes [`frohfdiv::W`](W) writer structure"]
impl crate::Writable for FrohfdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FROHFDIV to value 0x4000_0000"]
impl crate::Resettable for FrohfdivSpec {

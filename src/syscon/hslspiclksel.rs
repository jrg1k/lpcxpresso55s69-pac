...
pub type R = crate::R<HslspiclkselSpec>;
#[doc = "Register `HSLSPICLKSEL` writer"]
pub type W = crate::W<HslspiclkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - HS LSPI clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<HslspiclkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "HS LSPI clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`hslspiclksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hslspiclksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HslspiclkselSpec;
impl crate::RegisterSpec for HslspiclkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hslspiclksel::R`](R) reader structure"]
impl crate::Readable for HslspiclkselSpec {}
#[doc = "`write(|w| ..)` method takes [`hslspiclksel::W`](W) writer structure"]
impl crate::Writable for HslspiclkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HSLSPICLKSEL to value 0x07"]
impl crate::Resettable for HslspiclkselSpec {

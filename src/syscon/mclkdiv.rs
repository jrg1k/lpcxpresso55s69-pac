#[doc = "Register `MCLKDIV` reader"]
pub type R = crate::R<MclkdivSpec>;
#[doc = "Register `MCLKDIV` writer"]
pub type W = crate::W<MclkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<MclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<MclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<MclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "I2S MCLK clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`mclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct MclkdivSpec;
impl crate::RegisterSpec for MclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mclkdiv::R`](R) reader structure"]
impl crate::Readable for MclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`mclkdiv::W`](W) writer structure"]
impl crate::Writable for MclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MCLKDIV to value 0x4000_0000"]
impl crate::Resettable for MclkdivSpec {

#[doc = "Register `PLL0CLKDIV` reader"]
pub type R = crate::R<Pll0clkdivSpec>;
#[doc = "Register `PLL0CLKDIV` writer"]
pub type W = crate::W<Pll0clkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<Pll0clkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<Pll0clkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<Pll0clkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "PLL0 clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`pll0clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll0clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pll0clkdivSpec;
impl crate::RegisterSpec for Pll0clkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll0clkdiv::R`](R) reader structure"]
impl crate::Readable for Pll0clkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`pll0clkdiv::W`](W) writer structure"]
impl crate::Writable for Pll0clkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL0CLKDIV to value 0x4000_0000"]
impl crate::Resettable for Pll0clkdivSpec {

...
pub type R = crate::R<SdioclkselSpec>;
#[doc = "Register `SDIOCLKSEL` writer"]
pub type W = crate::W<SdioclkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - SDIO clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<SdioclkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "SDIO clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`sdioclksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sdioclksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SdioclkselSpec;
impl crate::RegisterSpec for SdioclkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sdioclksel::R`](R) reader structure"]
impl crate::Readable for SdioclkselSpec {}
#[doc = "`write(|w| ..)` method takes [`sdioclksel::W`](W) writer structure"]
impl crate::Writable for SdioclkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SDIOCLKSEL to value 0x07"]
impl crate::Resettable for SdioclkselSpec {

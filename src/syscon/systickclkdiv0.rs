#[doc = "Register `SYSTICKCLKDIV0` reader"]
pub type R = crate::R<Systickclkdiv0Spec>;
#[doc = "Register `SYSTICKCLKDIV0` writer"]
pub type W = crate::W<Systickclkdiv0Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<Systickclkdiv0Spec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<Systickclkdiv0Spec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<Systickclkdiv0Spec> {
        HaltW::new(self, 30)
    }
}
#[doc = "System Tick Timer divider for CPU0\n\nYou can [`read`](crate::Reg::read) this register and get [`systickclkdiv0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`systickclkdiv0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Systickclkdiv0Spec;
impl crate::RegisterSpec for Systickclkdiv0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`systickclkdiv0::R`](R) reader structure"]
impl crate::Readable for Systickclkdiv0Spec {}
#[doc = "`write(|w| ..)` method takes [`systickclkdiv0::W`](W) writer structure"]
impl crate::Writable for Systickclkdiv0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SYSTICKCLKDIV0 to value 0x4000_0000"]
impl crate::Resettable for Systickclkdiv0Spec {

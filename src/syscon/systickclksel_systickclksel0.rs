...
pub type R = crate::R<SystickclkselSystickclksel0Spec>;
#[doc = "Register `SYSTICKCLKSEL0` writer"]
pub type W = crate::W<SystickclkselSystickclksel0Spec>;
...
impl W {
    #[doc = "Bits 0:2 - System Tick Timer for CPU0 source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<SystickclkselSystickclksel0Spec> {
        SelW::new(self, 0)
    }
}
#[doc = "System Tick Timer for CPU0 source select\n\nYou can [`read`](crate::Reg::read) this register and get [`systickclksel_systickclksel0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`systickclksel_systickclksel0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SystickclkselSystickclksel0Spec;
impl crate::RegisterSpec for SystickclkselSystickclksel0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`systickclksel_systickclksel0::R`](R) reader structure"]
impl crate::Readable for SystickclkselSystickclksel0Spec {}
#[doc = "`write(|w| ..)` method takes [`systickclksel_systickclksel0::W`](W) writer structure"]
impl crate::Writable for SystickclkselSystickclksel0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SYSTICKCLKSEL0 to value 0x07"]
impl crate::Resettable for SystickclkselSystickclksel0Spec {

#[doc = "Register `TRACECLKDIV` reader"]
pub type R = crate::R<TraceclkdivSpec>;
#[doc = "Register `TRACECLKDIV` writer"]
pub type W = crate::W<TraceclkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<TraceclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<TraceclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<TraceclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "TRACE clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`traceclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`traceclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TraceclkdivSpec;
impl crate::RegisterSpec for TraceclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`traceclkdiv::R`](R) reader structure"]
impl crate::Readable for TraceclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`traceclkdiv::W`](W) writer structure"]
impl crate::Writable for TraceclkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TRACECLKDIV to value 0x4000_0000"]
impl crate::Resettable for TraceclkdivSpec {

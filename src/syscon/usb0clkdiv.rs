#[doc = "Register `USB0CLKDIV` reader"]
pub type R = crate::R<Usb0clkdivSpec>;
#[doc = "Register `USB0CLKDIV` writer"]
pub type W = crate::W<Usb0clkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<Usb0clkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<Usb0clkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<Usb0clkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "USB0 Clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`usb0clkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb0clkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb0clkdivSpec;
impl crate::RegisterSpec for Usb0clkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb0clkdiv::R`](R) reader structure"]
impl crate::Readable for Usb0clkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`usb0clkdiv::W`](W) writer structure"]
impl crate::Writable for Usb0clkdivSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB0CLKDIV to value 0x4000_0000"]
impl crate::Resettable for Usb0clkdivSpec {

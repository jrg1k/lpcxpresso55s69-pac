...
pub type R = crate::R<Usb0clkselSpec>;
#[doc = "Register `USB0CLKSEL` writer"]
pub type W = crate::W<Usb0clkselSpec>;
...
#[doc = "Field `SEL` reader - FS USB clock source select."]
...
#[doc = "Field `SEL` writer - FS USB clock source select."]
...
impl R {
    #[doc = "Bits 0:2 - FS USB clock source select."]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:2 - FS USB clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<Usb0clkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "FS USB clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`usb0clksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb0clksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb0clkselSpec;
impl crate::RegisterSpec for Usb0clkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb0clksel::R`](R) reader structure"]
impl crate::Readable for Usb0clkselSpec {}
#[doc = "`write(|w| ..)` method takes [`usb0clksel::W`](W) writer structure"]
impl crate::Writable for Usb0clkselSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB0CLKSEL to value 0x07"]
impl crate::Resettable for Usb0clkselSpec {

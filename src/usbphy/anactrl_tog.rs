#[doc = "Register `ANACTRL_TOG` reader"]
pub type R = crate::R<AnactrlTogSpec>;
...
impl W {
    #[doc = "Bit 1 - Vow voltage detector enable bit."]
    #[inline(always)]
    pub fn lvi_en(&mut self) -> LviEnW<AnactrlTogSpec> {
        LviEnW::new(self, 1)
    }
    #[doc = "Bits 2:3 - For normal USB operation, this bit field must remain at value 2'b00."]
    #[inline(always)]
    pub fn pfd_clk_sel(&mut self) -> PfdClkSelW<AnactrlTogSpec> {
        PfdClkSelW::new(self, 2)
    }
    #[doc = "Bit 10 - Setting this field to 1'b1 will enable the 15kohm pulldown resistors on both USB_DP and USB_DM pins"]
    #[inline(always)]
    pub fn dev_pulldown(&mut self) -> DevPulldownW<AnactrlTogSpec> {
...
pub struct AnactrlTogSpec;
impl crate::RegisterSpec for AnactrlTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`anactrl_tog::R`](R) reader structure"]
impl crate::Readable for AnactrlTogSpec {}
#[doc = "`write(|w| ..)` method takes [`anactrl_tog::W`](W) writer structure"]
impl crate::Writable for AnactrlTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets ANACTRL_TOG to value 0x0a00_0402"]
impl crate::Resettable for AnactrlTogSpec {

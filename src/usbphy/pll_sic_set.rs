#[doc = "Register `PLL_SIC_SET` reader"]
pub type R = crate::R<PllSicSetSpec>;
#[doc = "Register `PLL_SIC_SET` writer"]
pub type W = crate::W<PllSicSetSpec>;
...
impl W {
    #[doc = "Bit 6 - Enables the USB clock from PLL to USB PHY"]
    #[inline(always)]
    pub fn pll_en_usb_clks(&mut self) -> PllEnUsbClksW<PllSicSetSpec> {
        PllEnUsbClksW::new(self, 6)
    }
    #[doc = "Bit 12 - Power up the USB PLL"]
    #[inline(always)]
    pub fn pll_power(&mut self) -> PllPowerW<PllSicSetSpec> {
        PllPowerW::new(self, 12)
    }
    #[doc = "Bit 13 - Enables the clock output from the USB PLL"]
    #[inline(always)]
    pub fn pll_enable(&mut self) -> PllEnableW<PllSicSetSpec> {
        PllEnableW::new(self, 13)
    }
    #[doc = "Bit 19 - Reference bias power down select."]
    #[inline(always)]
    pub fn refbias_pwd_sel(&mut self) -> RefbiasPwdSelW<PllSicSetSpec> {
        RefbiasPwdSelW::new(self, 19)
    }
    #[doc = "Bit 20 - Power down the reference bias This bit is only used when REFBIAS_PWD_SEL is set to 1."]
    #[inline(always)]
    pub fn refbias_pwd(&mut self) -> RefbiasPwdW<PllSicSetSpec> {
        RefbiasPwdW::new(self, 20)
    }
    #[doc = "Bit 21 - This field controls the USB PLL regulator, set to enable the regulator"]
    #[inline(always)]
    pub fn pll_reg_enable(&mut self) -> PllRegEnableW<PllSicSetSpec> {
        PllRegEnableW::new(self, 21)
    }
    #[doc = "Bits 22:24 - This field controls the USB PLL feedback loop divider"]
    #[inline(always)]
    pub fn pll_div_sel(&mut self) -> PllDivSelW<PllSicSetSpec> {
        PllDivSelW::new(self, 22)
    }
    #[doc = "Bit 30 - This is selection between /1 or /2 to expand the range of ref input clock."]
    #[inline(always)]
    pub fn pll_prediv(&mut self) -> PllPredivW<PllSicSetSpec> {
...
pub struct PllSicSetSpec;
impl crate::RegisterSpec for PllSicSetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_sic_set::R`](R) reader structure"]
impl crate::Readable for PllSicSetSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_sic_set::W`](W) writer structure"]
impl crate::Writable for PllSicSetSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_SIC_SET to value 0x00d1_2000"]
impl crate::Resettable for PllSicSetSpec {

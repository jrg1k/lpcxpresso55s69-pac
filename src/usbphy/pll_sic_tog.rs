...
pub type R = crate::R<PllSicTogSpec>;
#[doc = "Register `PLL_SIC_TOG` writer"]
pub type W = crate::W<PllSicTogSpec>;
...
impl W {
    #[doc = "Bit 6 - Enables the USB clock from PLL to USB PHY"]
    #[inline(always)]
    pub fn pll_en_usb_clks(&mut self) -> PllEnUsbClksW<PllSicTogSpec> {
        PllEnUsbClksW::new(self, 6)
    }
    #[doc = "Bit 12 - Power up the USB PLL"]
    #[inline(always)]
    pub fn pll_power(&mut self) -> PllPowerW<PllSicTogSpec> {
        PllPowerW::new(self, 12)
    }
    #[doc = "Bit 13 - Enables the clock output from the USB PLL"]
    #[inline(always)]
    pub fn pll_enable(&mut self) -> PllEnableW<PllSicTogSpec> {
        PllEnableW::new(self, 13)
    }
    #[doc = "Bit 19 - Reference bias power down select."]
    #[inline(always)]
    pub fn refbias_pwd_sel(&mut self) -> RefbiasPwdSelW<PllSicTogSpec> {
        RefbiasPwdSelW::new(self, 19)
    }
    #[doc = "Bit 20 - Power down the reference bias This bit is only used when REFBIAS_PWD_SEL is set to 1."]
    #[inline(always)]
    pub fn refbias_pwd(&mut self) -> RefbiasPwdW<PllSicTogSpec> {
        RefbiasPwdW::new(self, 20)
    }
    #[doc = "Bit 21 - This field controls the USB PLL regulator, set to enable the regulator"]
    #[inline(always)]
    pub fn pll_reg_enable(&mut self) -> PllRegEnableW<PllSicTogSpec> {
        PllRegEnableW::new(self, 21)
    }
    #[doc = "Bits 22:24 - This field controls the USB PLL feedback loop divider"]
    #[inline(always)]
    pub fn pll_div_sel(&mut self) -> PllDivSelW<PllSicTogSpec> {
        PllDivSelW::new(self, 22)
    }
    #[doc = "Bit 30 - This is selection between /1 or /2 to expand the range of ref input clock."]
    #[inline(always)]
    pub fn pll_prediv(&mut self) -> PllPredivW<PllSicTogSpec> {
        PllPredivW::new(self, 30)
    }
}
#[doc = "USB PHY PLL Control/Status Register\n\nYou can [`read`](crate::Reg::read) this register and get [`pll_sic_tog::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pll_sic_tog::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PllSicTogSpec;
impl crate::RegisterSpec for PllSicTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pll_sic_tog::R`](R) reader structure"]
impl crate::Readable for PllSicTogSpec {}
#[doc = "`write(|w| ..)` method takes [`pll_sic_tog::W`](W) writer structure"]
impl crate::Writable for PllSicTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets PLL_SIC_TOG to value 0x00d1_2000"]
impl crate::Resettable for PllSicTogSpec {

...
pub type R = crate::R<RxSetSpec>;
#[doc = "Register `RX_SET` writer"]
pub type W = crate::W<RxSetSpec>;
...
impl W {
    #[doc = "Bits 0:2 - The ENVADJ field adjusts the trip point for the envelope detector"]
    #[inline(always)]
    pub fn envadj(&mut self) -> EnvadjW<RxSetSpec> {
        EnvadjW::new(self, 0)
    }
    #[doc = "Bits 4:6 - The DISCONADJ field adjusts the trip point for the disconnect detector."]
    #[inline(always)]
    pub fn disconadj(&mut self) -> DisconadjW<RxSetSpec> {
        DisconadjW::new(self, 4)
    }
    #[doc = "Bit 22 - This test mode is intended for lab use only, replace FS differential receiver with DP single ended receiver"]
    #[inline(always)]
    pub fn rxdbypass(&mut self) -> RxdbypassW<RxSetSpec> {
        RxdbypassW::new(self, 22)
    }
}
#[doc = "USB PHY Receiver Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_set::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rx_set::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RxSetSpec;
impl crate::RegisterSpec for RxSetSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rx_set::R`](R) reader structure"]
impl crate::Readable for RxSetSpec {}
#[doc = "`write(|w| ..)` method takes [`rx_set::W`](W) writer structure"]
impl crate::Writable for RxSetSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RX_SET to value 0"]
impl crate::Resettable for RxSetSpec {

...
pub type R = crate::R<TxClrSpec>;
#[doc = "Register `TX_CLR` writer"]
pub type W = crate::W<TxClrSpec>;
...
#[doc = "USB PHY Transmitter Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxClrSpec;
impl crate::RegisterSpec for TxClrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_clr::R`](R) reader structure"]
impl crate::Readable for TxClrSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_clr::W`](W) writer structure"]
impl crate::Writable for TxClrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TX_CLR to value 0x0a00_0402"]
impl crate::Resettable for TxClrSpec {

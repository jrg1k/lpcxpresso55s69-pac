...
pub type R = crate::R<TxTogSpec>;
#[doc = "Register `TX_TOG` writer"]
pub type W = crate::W<TxTogSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Decode to trim the nominal 17"]
    #[inline(always)]
    pub fn d_cal(&mut self) -> DCalW<TxTogSpec> {
        DCalW::new(self, 0)
    }
    #[doc = "Bits 8:11 - Decode to trim the nominal 45ohm series termination resistance to the USB_DM output pin"]
    #[inline(always)]
    pub fn txcal45dm(&mut self) -> Txcal45dmW<TxTogSpec> {
        Txcal45dmW::new(self, 8)
    }
    #[doc = "Bit 13 - Enable resistance calibration on DN."]
    #[inline(always)]
    pub fn txencal45dn(&mut self) -> Txencal45dnW<TxTogSpec> {
        Txencal45dnW::new(self, 13)
    }
    #[doc = "Bits 16:19 - Decode to trim the nominal 45ohm series termination resistance to the USB_DP output pin"]
    #[inline(always)]
    pub fn txcal45dp(&mut self) -> Txcal45dpW<TxTogSpec> {
        Txcal45dpW::new(self, 16)
    }
    #[doc = "Bit 21 - Enable resistance calibration on DP."]
    #[inline(always)]
    pub fn txencal45dp(&mut self) -> Txencal45dpW<TxTogSpec> {
        Txencal45dpW::new(self, 21)
    }
}
#[doc = "USB PHY Transmitter Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`tx_tog::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tx_tog::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxTogSpec;
impl crate::RegisterSpec for TxTogSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_tog::R`](R) reader structure"]
impl crate::Readable for TxTogSpec {}
#[doc = "`write(|w| ..)` method takes [`tx_tog::W`](W) writer structure"]
impl crate::Writable for TxTogSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets TX_TOG to value 0x0a00_0402"]
impl crate::Resettable for TxTogSpec {

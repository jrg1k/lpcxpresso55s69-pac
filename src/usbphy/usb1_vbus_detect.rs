...
pub type R = crate::R<Usb1VbusDetectSpec>;
...
impl W {
    #[doc = "Bits 0:2 - Sets the threshold for the VBUSVALID comparator"]
    #[inline(always)]
    pub fn vbusvalid_thresh(&mut self) -> VbusvalidThreshW<Usb1VbusDetectSpec> {
        VbusvalidThreshW::new(self, 0)
    }
    #[doc = "Bit 3 - VBUS detect signal override enable"]
    #[inline(always)]
    pub fn vbus_override_en(&mut self) -> VbusOverrideEnW<Usb1VbusDetectSpec> {
...
is set to value 1'b1"]
    #[inline(always)]
    pub fn sessend_override(&mut self) -> SessendOverrideW<Usb1VbusDetectSpec> {
...
is set to value 1'b1"]
    #[inline(always)]
    pub fn bvalid_override(&mut self) -> BvalidOverrideW<Usb1VbusDetectSpec> {
...
is set to value 1'b1"]
    #[inline(always)]
    pub fn avalid_override(&mut self) -> AvalidOverrideW<Usb1VbusDetectSpec> {
        AvalidOverrideW::new(self, 6)
    }
    #[doc = "Bit 7 - Override value for VBUS_VALID signal sent to USB controller The bit field provides the value for VBUS_VALID reported to the USB controller if the value of USB1_VBUS_DETECT\\[3\\]
is set to 1'b1"]
    #[inline(always)]
    pub fn vbusvalid_override(&mut self) -> VbusvalidOverrideW<Usb1VbusDetectSpec> {
        VbusvalidOverrideW::new(self, 7)
    }
    #[doc = "Bit 8 - Selects the source of the VBUS_VALID signal reported to the USB controller This is one of the bit fields that selects the source of the VBUS_VALID signal reported to the USB controller"]
    #[inline(always)]
    pub fn vbusvalid_sel(&mut self) -> VbusvalidSelW<Usb1VbusDetectSpec> {
        VbusvalidSelW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Selects the source of the VBUS_VALID signal reported to the USB controller This is one of the bit fields that selects the source of the VBUS_VALID signal reported to the USB controller"]
    #[inline(always)]
    pub fn vbus_source_sel(&mut self) -> VbusSourceSelW<Usb1VbusDetectSpec> {
        VbusSourceSelW::new(self, 9)
    }
    #[doc = "Bit 11 - Enable ID override using the register field. This bit is only used if EXT_ID_OVERRIDE_EN = 1'b0."]
    #[inline(always)]
    pub fn id_override_en(&mut self) -> IdOverrideEnW<Usb1VbusDetectSpec> {
        IdOverrideEnW::new(self, 11)
    }
    #[doc = "Bit 12 - ID override value."]
    #[inline(always)]
    pub fn id_override(&mut self) -> IdOverrideW<Usb1VbusDetectSpec> {
        IdOverrideW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable ID override using the pinmuxed value:"]
    #[inline(always)]
    pub fn ext_id_override_en(&mut self) -> ExtIdOverrideEnW<Usb1VbusDetectSpec> {
        ExtIdOverrideEnW::new(self, 13)
    }
    #[doc = "Bit 14 - Enable VBUS override using the pinmuxed value."]
    #[inline(always)]
    pub fn ext_vbus_override_en(&mut self) -> ExtVbusOverrideEnW<Usb1VbusDetectSpec> {
        ExtVbusOverrideEnW::new(self, 14)
    }
    #[doc = "Bit 18 - Selects the comparator used for VBUS_VALID This bit field controls the comparator used to report the VBUS_VALID results in USB1_VBUS_DETECT\\[3\\]
between the VBUS_VALID comparator and the Session Valid comparator"]
    #[inline(always)]
    pub fn vbusvalid_to_sessvalid(&mut self) -> VbusvalidToSessvalidW<Usb1VbusDetectSpec> {
        VbusvalidToSessvalidW::new(self, 18)
    }
    #[doc = "Bit 19 - no description available"]
    #[inline(always)]
    pub fn vbusvalid_5vdetect(&mut self) -> Vbusvalid5vdetectW<Usb1VbusDetectSpec> {
        Vbusvalid5vdetectW::new(self, 19)
    }
    #[doc = "Bits 20:22 - Enables the VBUS_VALID comparator: Powers up the comparator used for the VBUS_VALID detector"]
    #[inline(always)]
    pub fn pwrup_cmps(&mut self) -> PwrupCmpsW<Usb1VbusDetectSpec> {
        PwrupCmpsW::new(self, 20)
    }
    #[doc = "Bit 26 - Controls VBUS discharge resistor This bit field controls a nominal 22kohm resistor between the USB1_VBUS pin and ground"]
    #[inline(always)]
    pub fn discharge_vbus(&mut self) -> DischargeVbusW<Usb1VbusDetectSpec> {
        DischargeVbusW::new(self, 26)
    }
}
#[doc = "USB PHY VBUS Detect Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`usb1_vbus_detect::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`usb1_vbus_detect::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Usb1VbusDetectSpec;
impl crate::RegisterSpec for Usb1VbusDetectSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`usb1_vbus_detect::R`](R) reader structure"]
impl crate::Readable for Usb1VbusDetectSpec {}
#[doc = "`write(|w| ..)` method takes [`usb1_vbus_detect::W`](W) writer structure"]
impl crate::Writable for Usb1VbusDetectSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets USB1_VBUS_DETECT to value 0x0070_0004"]
impl crate::Resettable for Usb1VbusDetectSpec {
